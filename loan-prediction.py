...
loaded_model_LR = joblib.load(open("loan_predition_model.pkl", 'rb'))
...
with st.container():
    ...
    with right_column:
        ...
        st.info('[LinkedIn](https://www.linkedin.com/in/dharssini-karthikeyan/)', icon="📩")
        st.info('[Whatsapp](https://wa.me/+919677540483)', icon="📲")
...
<div class="footer">
<p>&copy; 2023 <a href="https://www.linkedin.com/in/dharssini-karthikeyan/"> Ali Abdallah</a></p>
</div>
"""
